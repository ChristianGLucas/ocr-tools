...
https://dev.axiomide.com/marketplace/christiangeorgelucas/ocr-tools@0.2.0
...
```bash
axiom invoke christiangeorgelucas/ocr-tools/Recognize --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/ocr-tools/0.2.0/Recognize \
...
> `axiom inspect node christiangeorgelucas/ocr-tools/Recognize`.
